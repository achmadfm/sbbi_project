					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<ul class="breadcrumb">
									<li><a href="#">Home</a></li>
									<li class="active">Program Sekolah</li>
								</ul>
							</div>
						</div>
						<div class="row">
				...
				<div class="container">
					<div class="row">
							...
							<div class="owl-theme">
								<div>
									<span class="img-thumbnail">
										<img alt="" style="width:300px; height:200px;" class="img-responsive" src="<?php echo base_url().'template/program/'.$foto?>">
									</span>
								</div>
							</div>
						</div>
						<div class="col-md-9">
							...
							<h4>Program Sekolah</h4>
							<span><i class="fa fa-user"></i> Postingan : <?php echo $author;?> </span>
							<hr class="solid">
							<p><?php echo $desk;?></p>
							<a href="<?php echo base_url('program')?>" class="btn btn-lg btn-primary pull-right">Kembali</a>
						</div>
					</div>
				</div>
			</div>
