...
<html>
	<head>
        ...
        })(window,document,'script','dataLayer','GTM-PSK38PN');</script>
        <!-- End Google Tag Manager -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-116845928-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
    
        gtag('config', 'UA-116845928-1');
        </script>
		<!-- Basic -->
		<meta charset="utf-8">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<h2 class="mb-none">Visi dan Misi</h2>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<hr>
									<h4>I. Visi</h4>
									<p>Menjadi Lembaga Pendidikan Islam yang terdepan dalam melahirkan Generasi Pemimpin terbaik bangsa yang <strong>SMART</strong>,<strong> ISLAMIC</strong>,<strong> DISCIPLINE</strong>, <strong>INNOVATIVE</strong>, dan <strong> COMPETITIVE</strong>
									dalam kancah kehidupan Global</p>
									<br>
									<h4>II. Misi</h4>
									<p>
									    <ol>
									        <li>Menciptakan iklim belajar yang kondusif dengan lingkungan yang nyaman</li>
									        <li>Mengembangkan Sekolah Terpadu yang dilandasi nilai - nilai Islam</li>
									        <li>Menumbuhkan sikap dan jiwa kepemimpinan, kemandirian, dan kepekaan sosial dalam integritas pribadi yang disiplin dan tangguh</li>
									        <li>Mewujudkan proses pembelajaran yang aktif, kreatif, inovatif dan menyenangkan selaras dengan tuntutan dan perubahan zaman</li>
									        <li>Menumbuhkan semangat dan budaya belajar yang tinggi dalam meraih prestasi</li>
									        <li>Memberikan manfaat bagi peningkatan sumber daya manusia</li>
									    </ol>
									</p>
									<h4>III. Tujuan</h4>
									<p>
									    Mewujudkan rencana dan aturan terkait tujuan, isi, dan bahan pembelajaran serta cara yang digunakan sebagai pedoman penyelenggaraan kegiatan pembelajaran
									    untuk mencapai profil pembelajar Bosowa School sesuai dengan tahap perkembangan anak
									</p>
									<h4>IV. Profil Pembelajar</h4>
									    <p><ol>
									        <li>Religius</li>
									        <li>Jujur</li>
									        <li>Adil</li>
