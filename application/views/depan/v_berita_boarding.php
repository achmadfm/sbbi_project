...
<html>
	<head>
		...
		<title>Berita Asrama | Bosowa Bina Insani Bogor</title>
									...
									<div class="row">
										...
										<div class="col-md-7">
											...
											<div class="post-content">
												...
												<h2><a href="<?php echo site_url().'news/'.$row->tulisan_slug;?>"><?php echo $row->tulisan_judul;?></a></h2>
												<div class="post-meta">
													<span><i class="fa fa-calendar"></i> Tanggal : <?php echo Berita_boarding::format_tanggal($row->tanggal);?> </span>
												...
												<p><?php echo limit_words($row->tulisan_isi,30).'...'?></p>
							...
							<aside class="sidebar">
								...
								<form action="<?php echo base_url('berita/search');?>" method="get">
									<div class="input-group input-group-lg">
										<input class="form-control" placeholder="Search..." name="textcari" type="text">
								...
								<ul class="nav nav-list flex-column mb-5">
									<?php foreach($category->result() as $row ) : ?>
										<li class="nav-item"><a class="nav-link" href="<?php echo site_url('berita_boarding/kategori/'.str_replace(" ","-",$row->kategori_nama));?>"><?php echo $row->kategori_nama;?></a></li>
									<?php endforeach;?>
								</ul>
											...
											<ul class="simple-post-list">
												...
												<li>
													...
													<div class="post-info">
														...
														<div class="post-meta">
															<?php echo Berita_boarding::format_tanggal($row->tanggal);?>
														</div>
													</div>
												</li>
											<?php endforeach;?>
