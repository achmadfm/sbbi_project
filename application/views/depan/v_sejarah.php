...
<html>
	...
	<head>
		...
		<title>Sejarah Sekolah | Bosowa Bina Insani Bogor</title>
        ...
        <div class="container">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<h2>Sejarah Bosowa Bina Insani Bogor</h2>
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<div class="text-center" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'containerSelector': '.sticky-container', 'padding': {'top': 110}}">
											<img src="<?php echo base_url('template/logo_b.png')?>" class="img-fluid appear-animation" height="250px" width="250px" data-appear-animation="bounceIn" data-appear-animation-delay="0" data-appear-animation-duration="1s">
										</div>
									</div>
								</div>
							</div>
