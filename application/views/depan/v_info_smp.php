...
<html>
	<head>
		...
		<title>Informasi SMP | Bosowa Bina Insani Bogor</title>
			...
			<div role="main" class="main">
				...
				<section class="page-header">
					<div class="container">
						...
						<div class="row">
							<div class="col">
								<h1>SMP Bosowa Bina Insani Bogor</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
					<div class="row">
						<div class="col">
							<h2 class="font-weight-bold text-color-dark" align="center">Informasi SMP </h2>
						</div>
							<div class="col-lg-8">
