...
<html>
	...
	<head>
        ...
        <!--    google_ad_client: "ca-pub-4485810354821477",-->
		...
		<title>Fasilitas | Sekolah Alam Bosowa</title>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="<?php echo base_url()?>materialize/sab_favicon.ico" type="image/x-icon" />
	...
	<body class="loading-overlay-showing" data-loading-overlay>
		...
		<div class="body">
			...
			<div role="main" class="main">
						...
						<div class="row">
							<div class="col-md-12">
								<ul class="breadcrumb">
									...
									<li>Profil</li>
									<li>Fasilitas</li>
									<li class="active">Sekolah Alam Bosowa</li>
								</ul>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<h1>Fasilitas Sekolah Alam Bosowa</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
					<div class="row">
						...
						foreach($fasilitassab->result_array() as $fas) :
			...
			<?php $this->load->view('depan/v_footer_sab')?>
		</div>
