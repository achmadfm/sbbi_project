...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116845928-1"></script>
		...
		<title>Program Unggulan | Bosowa School Makassar</title>
			...
			<div role="main" class="main">
				...
				<section class="page-header">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<h1>Program Unggulan Sekolah Alam Bosowa</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
					<div class="row">
						...
						foreach($prog_sab->result_array() as $prog) :
							$idp = $prog['id_program'];
