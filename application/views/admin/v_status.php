...
<head>
    ...
    <title>Student Status - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#" class="waves-effect"><i class="ti-desktop fa-fw"></i><span class="hide-menu">Kesiswaan<span class="fa arrow"></span></a>
                          <ul class="nav nav-third-level">
                            ...
                            <li><a href="<?php echo base_url('admin/status')?>" class="waves-effect active"><i class="icon-user-following fa-fw"></i><span class="hide-menu">Status</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Status</h4> </div>
                        <ol class="breadcrumb">
                            <li>Dashboard</li>
                            <li class="active">Data Status Siswa</li>
                        </ol>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus fa-fw"></span>Tambah Status</button>
                          <hr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td style="text-align:right;">
                                                <a class="btn btn-success btn-circle" data-toggle="modal" data-target="#ModalEdit<?php echo $id_status;?>"><span class="fa fa-pencil"></span></a>
                                                <a class="btn btn-danger btn-circle" data-toggle="modal" data-target="#ModalHapus<?php echo $id_status;?>"><span class="fa fa-trash"></span></a>
                                          </td>
                                        </tr>
                                      <?php endforeach;?>
                                    </tbody>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add Status</h4> </div>
                            <div class="modal-body">
                                <form action="<?php echo base_url().'admin/status/simpan_status'?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Nama Status</label>
                                        <input type="text" name="xstatus" class="form-control" id="recipient-name">
                                    </div>

                                    <div class="form-group">
                                      <label for="recipient-name" class="control-label">Tipe Status</label>
                                        <select class="form-control" name="xtipe" data-placeholder="Choose a Type" tabindex="1">
                                            <option value="Category 1">-Pilih-</option>
                                            <?php
                                              foreach($t->result_array() as $i) :
                                                $idti = $i['id_tipe'];
                                                $nama = $i['nama_tipe'];
                                            ?>
                                            <option value="<?php echo $idti;?>"><?php echo $nama;?></option>
                                          <?php endforeach;?>
                                        </select>
                                    </div>
                            </div>
                ...
                <div id="ModalEdit<?php echo $id_status;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h4 class="modal-title">Edit Status</h4> </div>
                            <div class="modal-body">
                                <form action="<?php echo base_url().'admin/status/update_status'?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Nama Status</label>
                                        <input type="hidden" name="kode" value="<?php echo $id_status;?>"/>
                                        <input type="text" name="xstatus" class="form-control" id="recipient-name" value="<?php echo $nama_status;?>">
                                      </div>
              ...
              <div id="ModalHapus<?php echo $id_status;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                              <h4 class="modal-title">Delete Status</h4> </div>
                          <div class="modal-body">
                              <form action="<?php echo base_url().'admin/status/hapus_status'?>" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="kode" value="<?php echo $id_status;?>"/>
                                <p>Apakah Anda yakin mau menghapus Status <b><?php echo $nama_status;?></b> ?</p>
                          </div>
                          <div class="modal-footer">
                              <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","Status successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","Status successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","Status successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
