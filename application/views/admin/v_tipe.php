...
<head>
    ...
    <title>Tipe Status - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#" class="waves-effect"><i class="ti-desktop fa-fw"></i><span class="hide-menu">Kesiswaan<span class="fa arrow"></span></a>
                          <ul class="nav nav-third-level">
                            ...
                            <li><a href="<?php echo base_url('admin/tipe_status')?>" class="waves-effect active"><i class="fa fa-bars fa-fw"></i><span class="hide-menu">Tipe Status</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            <li>Dashboard</li>
                            <li class="active">Data Tipe Status</li>
                        </ol>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus fa-fw"></span>Tambah Tipe</button>
                          <hr>
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                          <?php
          					                           ...
          					                           $no++;
                                               $id_tipe=$i['id_tipe'];
                                               $nama_tipe=$i['nama_tipe'];
                                          ?>
                                        <tr>
                                          <td><?php echo $no;?></td>
                                          <td><?php echo $nama_tipe;?></td>
                                          <td style="text-align:right;">
                                                <a class="btn btn-success btn-circle" data-toggle="modal" data-target="#ModalEdit<?php echo $id_tipe;?>"><span class="fa fa-pencil"></span></a>
                                                <a class="btn btn-danger btn-circle" data-toggle="modal" data-target="#ModalHapus<?php echo $id_tipe;?>"><span class="fa fa-trash"></span></a>
                                          </td>
                                        </tr>
                                      <?php endforeach;?>
                                    </tbody>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Add Tipe Status</h4> </div>
                            <div class="modal-body">
                                <form action="<?php echo base_url().'admin/tipe_status/tambah_tipe'?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Nama Status</label>
                                        <input type="text" name="xtipe" class="form-control" id="recipient-name"> </div>
                            </div>
                ...
                <div id="ModalEdit<?php echo $id_tipe;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h4 class="modal-title">Edit Tipe Status</h4> </div>
                            <div class="modal-body">
                                <form action="<?php echo base_url().'admin/tipe_status/ubah_tipe'?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="recipient-name" class="control-label">Nama Tipe Status</label>
                                        <input type="hidden" name="kode" value="<?php echo $id_tipe;?>"/>
                                        <input type="text" name="xtipe" class="form-control" id="recipient-name" value="<?php echo $nama_tipe;?>">
                                      </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
              ...
              <div id="ModalHapus<?php echo $id_tipe;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                              <h4 class="modal-title">Delete Tipe Status</h4> </div>
                          <div class="modal-body">
                              <form action="<?php echo base_url().'admin/tipe_status/hapus_tipe'?>" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="kode" value="<?php echo $id_tipe;?>"/>
                                <p>Apakah Anda yakin mau menghapus Tipe Status <b><?php echo $nama_tipe;?></b> ?</p>
                          </div>
                          <div class="modal-footer">
                              <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","Type successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","Type successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","Type successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
