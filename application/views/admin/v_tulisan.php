...
<head>
    ...
    <title>News - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">List Berita</h4> </div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                          <a href="<?php echo base_url('admin/tulisan/add_tulisan')?>" class="btn btn-info"><span class="fa fa-plus fa-fw"></span>Add Berita</a>
                          <hr>
                                ...
                                <table id="example23" class="display wrap" cellspacing="0" width="100%">
                                  <thead>
                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                        <tr>
                                          <td><img src="<?php echo base_url().'template/cover/'.$tulisan_gambar;?>" class="img img-rounded" style="width:90px;"></td>
                                          ...
                                          <td style="text-align:right;">
                                                <a class="btn btn-success btn-circle" href="<?php echo base_url().'admin/tulisan/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
                                                <a class="btn btn-danger btn-circle" data-toggle="modal" data-target="#ModalHapus<?php echo $tulisan_id;?>"><span class="fa fa-trash"></span></a>
                                          </td>
                                        </tr>
                                      <?php endforeach;?>
                                    </tbody>
                ...
                <?php foreach ($data->result_array() as $i) :
                  ...
                  $tulisan_gambar=$i['tulisan_gambar'];
                ?>
                <div id="ModalHapus<?php echo $tulisan_id;?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                  <h4 class="modal-title">Hapus Berita</h4> </div>
                              <div class="modal-body">
                               <form class="form-horizontal" action="<?php echo base_url().'admin/tulisan/hapus_tulisan'?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <p>Apakah Anda yakin mau menghapus Berita Ini <b><?php echo $tulisan_judul;?></b> ?</p>
                              </div>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","News successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","News successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","News successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
