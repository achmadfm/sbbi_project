...
<head>
    ...
    <title>Announcement - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
        ...
        <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav">
              <div class="sidebar-head">
                  ...
                  <li> <a href="<?php echo base_url('admin/pengumuman')?>" class="waves-effect active"><i class="mdi mdi-volume-high fa-fw"></i> <span class="hide-menu">Pengumuman</span></a></li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus fa-fw"></span>Tambah Pengumuman</button>
                            <hr>
                            <div class="table-responsive">
                                <table id="example23" class="display dt-responsive wrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","Announcement successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","Announcement successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","Announcement successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
