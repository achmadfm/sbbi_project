...
<head>
    ...
    <title>Class - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#" class="waves-effect active"><i class="ti-desktop fa-fw"></i><span class="hide-menu">Kesiswaan<span class="fa arrow"></span></a>
                          <ul class="nav nav-third-level">
                            ...
                            <li><a href="<?php echo base_url('admin/kelas')?>" class="waves-effect active"><i class="ti-desktop fa-fw"></i><span class="hide-menu">Kelas</span></a></li>
                                      ...
                                      ?>
                                        <tr>
                                          ...
                                          <td style="text-align:right;">
                                                <a class="btn btn-success btn-circle" data-toggle="modal" data-target="#ModalEdit<?php echo $kelas_id;?>"><span class="fa fa-pencil"></span></a>
                                                <a class="btn btn-danger btn-circle" data-toggle="modal" data-target="#ModalHapus<?php echo $kelas_id;?>"><span class="fa fa-trash"></span></a>
                                          </td>
                                        </tr>
                                      <?php endforeach;?>
                                    </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xkelas" class="form-control" id="inputUserName" placeholder="Kelas" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  ...
                                  <input type="text" name="xkelas" class="form-control" id="inputUserName" value="<?php echo $kelas_nama;?>" placeholder="Kelas" required>
                              </div>
                          </div>
  ...
  <?php foreach ($data->result_array() as $i) :
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","Class successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","Class successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","Class successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
