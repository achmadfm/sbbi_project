...
<head>
    ...
    <title>Achievements - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
              ...
              <div class="sidebar-head">
                  ...
                  <li> <a href="#" class="waves-effect active"><i  class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Lainnya</span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="#" class="waves-effect active"><i class="ti-desktop fa-fw"></i><span class="hide-menu">Kesiswaan<span class="fa arrow"></span></a>
                          <ul class="nav nav-third-level">
                            ...
                            <li><a href="<?php echo base_url('admin/prestasi')?>" class="waves-effect active"><i class="mdi mdi-trophy-variant fa-fw"></i><span class="hide-menu">Prestasi Siswa</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Data Prestasi</h4> </div>
                        <ol class="breadcrumb">
                            <li>Dashboard</li>
                            <li>Lainnya</li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addModal"><span class="fa fa-plus fa-fw"></span>Tambah Prestasi</button>
                            <hr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right;">
                                                    <a class="btn btn-success btn-circle" data-toggle="modal" data-target="#ModalEdit<?php echo $id_prestasi;?>"><span class="fa fa-pencil"></span></a>
                                                    <a class="btn btn-danger btn-circle" data-toggle="modal" data-target="#ModalHapus<?php echo $id_prestasi;?>"><span class="fa fa-trash"></span></a>
                                            </td>
                                        </tr>
                                        <?php endforeach;?>
                                    </tbody>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Prestasi Siswa</h4>
                              </div>
                            ...
                            <div class="modal-body">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-7">
                                        <input type="text" name="prestasi" class="form-control" id="inputUserName" placeholder="Nama Prestasi" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                      <div class="input-group date">
                                        ...
                                        <input type="text" name="xtanggal" class="form-control pull-right" id="datepicker" required>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                      <select class="form-control select2" name="xkategori">
                                  ...
                                  <div class="form-group">
                                    <label for="inputUserName" class="col-sm-4 control-label">Siswa</label>
                                    <div class="col-sm-7">
                                      <select class="form-control select2" name="xsiswa">
                                        <option value="0">-Pilih-</option>
                                        <?php
                                  ...
                                  <div class="form-group">
                                    <label class="col-sm-4 control-label">Upload Sampul</label>
                                    <div class="col-sm-7">
                ...
                <?php
                    ...
                    $deskripsi = $i['deskripsi'];
                    $tanggal = $i['tanggal'];
                    $id_kategori=$i['id_kategori_prestasi'];
                    $kategori = $i['nama_kategori'];
                    $id_siswa_prestasi = $i['id_siswa'];
                    $namasiswa = $i['nama_siswa'];
                    $id_kelas = $i['id_kelas'];
                    $kelas = $i['kelas'];
                ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel1">Prestasi Siswa</h4> </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                      <div class="input-group date">
                                        ...
                                        <input type="text" name="xtanggal" class="form-control pull-right" id="datepicker2" required>
                                      </div>
                                    </div>
                                  </div>
                                      ...
                                      <select class="form-control select2" name="xsiswa">
                                        ...
                                        <?php
                                          foreach($data->result_array() as $i) :
                                            ...
                                            $nama_siswa=$i['siswa_nama'];
                                        ?>
                                        <?php if($id_siswa==$id_siswa_prestasi) :?>
                                        <option value="<?php echo $id_siswa;?>" selected><?php echo $nama_siswa;?></option>
                                      <?php else : ?>
                                        <option value="<?php echo $id_siswa;?>"><?php echo $nama_siswa;?></option>
                                      <?php endif;?>
                                      <?php endforeach;?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                swal("Hooray!!","Achievements successful added","success")
        </script>
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                swal("Hooray!!","Achievements successful updated","info")
        </script>
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                swal("Hooray!!","Achievements successful deleted","success")
        </script>
      <?php else:?>
      <?php endif;?>
    <!--Style Switcher -->
