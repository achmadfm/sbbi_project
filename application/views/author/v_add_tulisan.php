...
<head>
    ...
    <title>Add Article - Admin Bosowa Bina Insani Bogor</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Post Article</h4> </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                ...
                                <div class="panel-body">
                                        <div class="form-body">
                                            <form action="<?php echo base_url('author/tulisan/simpan_tulisan')?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                        <textarea id="editor1" class="form-control" name="xisi" style="height:260px" required></textarea>
                                                </div>
                                                <div class="col-md-4">
                                                  <div class="form-group">
                                                      <label class="control-label">Category</label>
                                                      <select class="form-control" name="xkategori" data-placeholder="Choose a Category" tabindex="1">
                                                        <?php $art=$kat->row_array();?>
                                                          <option value="<?php echo $art['kategori_id'];?>"><?php echo $art['kategori_nama'];?></option>
                                                      </select>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <select class="form-control" name="xjenis" data-placeholder="Choose a Type" tabindex="1">
                                                        <?php $insight=$ins->row_array();?>
                                                          <option value="<?php echo $insight['id'];?>"><?php echo $insight['nama_jenis'];?></option>
                                                      </select>
                                                  </div>
                                                      <div class="form-group">
                                                          <button type="submit" class="btn btn-success"> <i class="fa fa-pencil"></i> Publish</button>
