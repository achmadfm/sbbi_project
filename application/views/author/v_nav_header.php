...
<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        <div class="top-left-part">
            <!-- Logo -->
            <a class="logo" href="<?php echo base_url('author/dashboard_author')?>">
        ...
        <ul class="nav navbar-top-links navbar-left">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                  ...
                  <?php endforeach;?>
                    <li>
                        <a class="text-center" href="<?php echo base_url().'author/inbox'?>"> <strong>See all messages</strong> <i class="fa fa-angle-right"></i> </a>
                    </li>
                </ul>
                <!-- /.dropdown-messages -->
            </li>
            ...
            <li class="dropdown">
                ...
                <?php else:?>
                <?php endif;?>
                <!-- <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="mdi mdi-comment-account"><i>
                </a> -->
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    <li>
                    ...
                    <li>
                      <div class="message-center">
                          <a href="<?php echo base_url().'admin/komentar'?>">
                              <div class="user-img"> <img src="<?php echo base_url().'template/images/userblank.png'?>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                              <div class="mail-contnet">
                                  <h5><?php echo $komentar_nama;?></h5> <span class="mail-desc"><?php echo $komentar_pesan;?></span> <span class="time"><?php echo $komentar_tgl;?></span> </div>
                          </a>
                      </div>
                    </li>
                  <?php endforeach;?>
                    <li>
                        <a class="text-center" href="<?php echo base_url().'author/komentar'?>"> <strong>See all Comments</strong> <i class="fa fa-angle-right"></i> </a>
                    </li>
                </ul>
                <!-- /.dropdown-messages -->
            </li>
