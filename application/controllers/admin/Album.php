...
class Album extends CI_Controller{
	...
	function simpan_album(){
				$config['upload_path'] = './template/album/'; //path folder
	      ...
	      $config['encrypt_name'] = TRUE; //nama yang terupload nantinya
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
                    ...
                    $config['source_image']='./template/album/'.$gbr['file_name'];
                    $config['create_thumb']= FALSE;
                    $config['maintain_ratio']= FALSE;
                    $config['quality']= '100%';
                    $config['width']= 500;
                    $config['height']= 400;
                    $config['new_image']= './template/album/'.$gbr['file_name'];
