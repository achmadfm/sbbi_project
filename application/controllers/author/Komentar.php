...
class Komentar extends CI_Controller{
    ...
    function index(){
        $x['data']=$this->db->query("SELECT tbl_komentar.*,artikel_judul,artikel_slug FROM tbl_komentar JOIN tbl_artikel ON komentar_artikel_id=artikel_id ORDER BY komentar_id DESC");
